  ...
  return createPortal(
    <dialog open={open} className="modal">
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        {/* Backdrop */}
        <div
          className="absolute inset-0 bg-gray-900/30 backdrop-blur-2xl bg-opacity-50"
          onClick={onClose}
        ></div>

        {/* Modal */}
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
          <LoadingComponent isLoading={isFetching || mutation.isPending} size="md" text="Loading passport data..." overlay>
            {/* Header */}
